...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Chitranjan%20Kumar%20Patel&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=B.Tech%20Engineer%20%7C%20Ethical%20Hacker%20%7C%20Full-Stack%20Developer&descAlignY=56&descAlign=50&descSize=18" width="100%"/>

<!-- Typing Animation -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=00D9FF&center=true&vCenter=true&random=false&width=600&lines=🔐+Ethical+Hacker+%26+Security+Researcher;💻+Full-Stack+Web+Developer;🤖+AI+%26+Machine+Learning+Enthusiast;🌐+Cyber+Security+Specialist;🚀+Building+the+Future+of+Tech)](https://git.io/typing-svg)

<br/>

<!-- Profile Views & Social Badges -->
![Profile Views](https://komarev.com/ghpvc/?username=chitranjan-patel&color=00d9ff&style=for-the-badge&label=PROFILE+VIEWS)
[![GitHub followers](https://img.shields.io/github/followers/chitranjan-patel?style=for-the-badge&color=00d9ff&labelColor=1a1a2e&label=FOLLOWERS)](https://github.com/chitranjan-patel?tab=followers)
[![GitHub stars](https://img.shields.io/github/stars/chitranjan-patel?style=for-the-badge&color=ffd700&labelColor=1a1a2e&label=TOTAL+STARS)](https://github.com/chitranjan-patel)
...
```python
class ChitranjanPatel:
    def __init__(self):
        self.name        = "Chitranjan Kumar Patel"
        self.role        = ["Ethical Hacker", "Full-Stack Developer", "ML Engineer"]
        self.education   = "B.Tech in Computer Science"
        self.location    = "Delhi, India 🇮🇳"
        self.website     = "www.blueteeth.in"
        self.passion     = ["Cyber Security", "Web Dev", "AI/ML", "Open Source"]
        self.currently   = "Building secure & scalable web applications"
        self.fun_fact    = "I break things to make them stronger 🔐"
...
```
🔭 Working on   → Advanced Cyber Security Research & Penetration Testing
🌱 Learning     → Cloud Security (AWS/Azure), DevSecOps, Malware Analysis
👯 Open to      → Collaborations on Security Tools & Full-Stack Projects
💬 Ask me about → Ethical Hacking, Web Development, Python, Machine Learning
🎯 2025 Goal    → CEH Certification + Launch www.blueteeth.in platform
...
**⭐ Star my repositories if you find them useful! | 💼 Open for Internships & Freelance Projects**
